...
└── 03.Navien/                          : 경동나비엔 통합 솔루션 VWE 계산기
    └── b2b-vwe-navien.html             : TCO 비교 분석 도구

※ 향후 기업별로 폴더를 추가하여 각 기업 맞춤 VWE 계산기를 관리합니다.
   예) 04.company_d/, 05.company_e/ ...
...
[03. 경동나비엔 통합 솔루션 VWE 계산기]
- 파일: 03.Navien/b2b-vwe-navien.html
- 용도: 건설사 대상 경동나비엔 통합 솔루션 TCO 비교 분석 도구
- 주요 기능:
  · 4개 솔루션 카테고리 (난방/에어케어/주방/스마트홈) 선택
  · 솔루션별 7개 항목 상세 스펙 비교 입력 (접기/펼치기 패널)
  · TCO 5대 비용 항목 비교 (장비구매/설치공사/에너지/소모품/관리인건비)
  · TCO 기간 선택 (3년/5년/10년)
  · 총 세대수 설정 (50~10,000 세대, 슬라이더)
  · 4개 요약 카드 (TCO 절감액, 인력 절감, 기간 단축, 효율 향상)
  · 설치 난이도 비교 (하/중/상 배지)
  · TCO 비교 분석표 (절감액/절감률)
  · 바 차트 + 도넛 차트 (Chart.js)
  · 솔루션별 상세 내역 카드
  ...
  · 반응형 디자인 (모바일 대응)
- 입력 항목:
  · 프로젝트명, 건설사명, 총 세대수, TCO 기간
  · 솔루션별: 구매가, 설치 난이도, 에너지 효율, 소모품 주기/비용, 관리비, 에너지비
- 기술: HTML5, CSS3, Vanilla JavaScript (단일 파일)
...
- 배포 URL:
  ...
  · 경동나비엔: https://jazzmania74.github.io/B2B-vwe/03.Navien/b2b-vwe-navien.html
